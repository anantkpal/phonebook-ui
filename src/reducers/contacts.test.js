...
describe('Contact reducers', () => {
  ...
  it('should return the initial state', () => {
    expect(reducer(undefined, {})).toEqual({ items: [], loading: false, searchText: '' });
  });

  it('should return the initial loading contacts state', () => {
    expect(reducer(undefined,
      { type: types.REQUEST_CONTACTS })).toEqual({ items: [], loading: true, searchText: '' });
  });
  ...
  it('should return the initial load contacts state', () => {
    expect(reducer(undefined,
      { type: types.SET_CONTACTS, contacts })).toEqual({ items: contacts, loading: false, searchText: '' });
  });
